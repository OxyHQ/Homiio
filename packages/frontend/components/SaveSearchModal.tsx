...
export const SaveSearchModal: React.FC<SaveSearchModalProps> = ({
  ...
  const handleSave = async () => {
    ...
    const success = await saveSearch(searchName.trim(), searchQuery, filters, notificationsEnabled);
          ...
          <View style={styles.toggleSection}>
            <View style={styles.toggleContent}>
              <View style={styles.toggleTextContainer}>
                ...
                <Text style={styles.toggleDescription}>{t('search.notificationsDescription')}</Text>
              </View>
              <Switch
