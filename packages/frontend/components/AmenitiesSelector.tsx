...
import { POPULAR_AMENITIES, getAmenityById, Amenity, getAmenitiesByPropertyType, getAmenityDescriptionByPropertyType } from '@/constants/amenities';
...
export function AmenitiesSelector({
    ...
    const availableAmenities = propertyType ? getAmenitiesByPropertyType(propertyType) : POPULAR_AMENITIES;
