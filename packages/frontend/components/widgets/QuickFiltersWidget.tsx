...
export function QuickFiltersWidget() {
  ...
  const quickFilters: QuickFilter[] = [
    {
      id: 'eco',
      label: t('Eco-friendly'),
      query: 'eco-friendly sustainable green',
      color: '#16a34a',
    },
  ...
  return (
    <BaseWidget title={t('Quick Filters')}>
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.advancedButton} onPress={handleAdvancedFilters}>
          <Text style={styles.advancedButtonText}>{t('Advanced Filters')}</Text>
        </TouchableOpacity>
      </View>
    </BaseWidget>
  );
