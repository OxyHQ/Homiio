...
export function NeighborhoodRatingWidget({
    ...
    useEffect(() => {
        if (isAuthenticated && (!currentNeighborhood || isDataStale())) {
            if (propertyId) {
                ...
                console.log('NeighborhoodRatingWidget: Fetching neighborhood by name:', neighborhoodName, city);
    ...
    }, [isAuthenticated, currentNeighborhood, isDataStale, fetchByName, fetchByProperty, propertyId, neighborhoodName, city, state]);
