...
import { View, Text, StyleSheet, TouchableOpacity, FlatList, Modal, Alert, Switch, TextInput } from 'react-native';
...
export function SavedSearchesWidget() {
    ...
    const { searches, isLoading, isAuthenticated, deleteSavedSearch, updateSearch, toggleNotifications } = useSavedSearches();
    ...
    const handleDeleteSavedSearch = async (search: SavedSearch) => {
        Alert.alert(
            ...
            t('search.deleteSearchConfirm', { name: search.name }),
            [
                    ...
                    <View style={styles.actionsContainer}>
                        {selectedSearch && (
                            <>
                                ...
                                >
                                    <IconComponent
                                        name={selectedSearch.notificationsEnabled ? "notifications-off-outline" : "notifications-outline"}
                                        size={20}
                                        color={colors.primaryColor}
                                    />
                                    <Text style={styles.actionText}>
                                        {selectedSearch.notificationsEnabled ? t('search.disableNotifications') : t('search.enableNotifications')}
                                    </Text>
                                </TouchableOpacity>
                ...
                <View style={styles.editModalOverlay}>
                    <View style={styles.editModalContent}>
                        ...
                        <View style={styles.actionButtons}>
                            ...
                            <TouchableOpacity
                                style={[styles.saveButton, (!editName.trim() || !editQuery.trim()) && styles.saveButtonDisabled]}
