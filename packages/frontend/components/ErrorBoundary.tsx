...
import { View, StyleSheet, TouchableOpacity, ScrollView, Clipboard, Alert, Platform } from 'react-native';
                ...
                <ScrollView contentContainerStyle={styles.container}>
                    ...
                    <View style={styles.buttonContainer}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={this.handleReportIssue}
                        >
                            <Ionicons name="bug" size={20} color={colors.primaryColor} style={styles.buttonIcon} />
