                ...
                <View style={styles.utilityToggleContainer}>
                    <TouchableOpacity
                        style={[
                            ...
                            selectedUtility === 'electricity' && { backgroundColor: 'rgba(255, 193, 7, 0.1)', borderColor: '#FFC107' }
                        ]}
                    ...
                    <TouchableOpacity
                        style={[
                            styles.utilityButton,
                            selectedUtility === 'water' && { backgroundColor: 'rgba(33, 150, 243, 0.1)', borderColor: '#2196F3' }
                        ]}
                    ...
                    <TouchableOpacity
                        style={[
                            styles.utilityButton,
                            selectedUtility === 'gas' && { backgroundColor: 'rgba(76, 175, 80, 0.1)', borderColor: '#4CAF50' }
                        ]}
                ...
                <View style={[styles.utilizationCard, { backgroundColor: utilityInfo.background }]}>
                    ...
                    <View style={styles.utilizationStats}>
                        <View style={styles.statItem}>
                            ...
                            <Text style={styles.statValue}>{utilityInfo.currentUsage} {utilityInfo.unit}</Text>
                        </View>
                        <View style={styles.statDivider} />
                        <View style={styles.statItem}>
                            <Text style={styles.statLabel}>{t("Average")}</Text>
                            <Text style={styles.statValue}>{utilityInfo.averageUsage} {utilityInfo.unit}</Text>
                        </View>
                        <View style={styles.statDivider} />
                        <View style={styles.statItem}>
                    ...
                    <View style={styles.savingsContainer}>
                        ...
                        <Text style={styles.savingsText}>{t("You're saving")} {utilityInfo.savings}</Text>
                    </View>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => router.push(`/properties/${propertyId}/usage-history?type=${selectedUtility}`)}
                    >
                    ...
                    <View style={styles.smartHomeHeader}>
                        ...
                        <View style={styles.smartHomeContent}>
                            ...
                            <Text style={styles.smartHomeDescription}>
                                {t("Link your smart home devices to monitor and control energy usage in real-time.")}
                            </Text>
                        </View>
                    </View>
