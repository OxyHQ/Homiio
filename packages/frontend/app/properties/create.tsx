...
export default function CreatePropertyScreen() {
  ...
  // Fix Ionicons usage for React 19 compatibility
  ...
  const validateCurrentStep = () => {
    ...
    if (currentStep === 0) { // Basic Info
      ...
      if (!formData.basicInfo.bedrooms && formData.basicInfo.bedrooms !== 0) errors.bedrooms = 'Number of bedrooms is required';
      if (!formData.basicInfo.bathrooms && formData.basicInfo.bathrooms !== 0) errors.bathrooms = 'Number of bathrooms is required';
      if (!formData.basicInfo.squareFootage) errors.squareFootage = 'Square footage is required';
    } else if (currentStep === 1) { // Location
      ...
      if (!formData.location.zipCode) errors.zipCode = 'ZIP code is required';
      if (!formData.location.latitude || !formData.location.longitude) errors.coordinates = 'Please select a location on the map';
    } else if (currentStep === 2) { // Pricing
      if (!formData.pricing.monthlyRent) errors.monthlyRent = 'Monthly rent is required';
    }
  ...
  const renderStepContent = () => {
    ...
    switch (stepName) {
      ...
      case 'Coliving Features':
        // Placeholder for Coliving Features step
        return (
          <View style={styles.formSection}>
            <ThemedText type="subtitle" style={styles.sectionTitle}>Coliving Features</ThemedText>
            <ThemedText>Coliving-specific features go here.</ThemedText>
          </View>
        );
