        ...
        <View key={draft.id} style={styles.draftCard}>
            <View style={styles.draftHeader}>
                <View style={styles.draftTypeContainer}>
                    ...
                    />
                    <ThemedText style={styles.draftType}>
                        {getPropertyTypeLabel(draft.type)}
                    </ThemedText>
                </View>
                <View style={styles.draftActions}>
                    <TouchableOpacity
                        style={styles.actionButton}
                        onPress={() => continueEditing(draft)}
                    >
            ...
            <View style={styles.draftContent}>
                ...
                <ThemedText style={styles.draftAddress}>
                    {draft.address.street}, {draft.address.city}, {draft.address.state} {draft.address.zipCode}
                </ThemedText>

                {draft.rent.amount > 0 && (
                    <ThemedText style={styles.draftPrice}>
                        ${draft.rent.amount.toLocaleString()}/{draft.rent.currency === 'USD' ? 'month' : draft.rent.currency}
                    </ThemedText>
                )}
                ...
                <View style={styles.draftMeta}>
                    <View style={styles.draftMetaItem}>
                        ...
                        <ThemedText style={styles.draftMetaText}>
