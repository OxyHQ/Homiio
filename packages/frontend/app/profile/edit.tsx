...
export default function ProfileEditScreen() {
  ...
  console.log(
    'ProfileEditScreen: Determined profileType:',
    profileType,
    'from activeProfile.profileType:',
  ...
  const [agencyInfo, setAgencyInfo] = useState({
    businessType: 'real_estate_agency' as
      | 'real_estate_agency'
      | 'property_management'
      | 'brokerage'
      | 'developer'
  ...
  useEffect(() => {
    ...
    if (profileType === 'personal') {
      ...
      console.log(
        'ProfileEditScreen: Unknown profile type or no profile data, initializing with defaults',
      );
      setIsFormInitialized(true);
    }
  }, [
  ...
  const updateRentalHistory = useCallback(
    (index: number, updates: Partial<(typeof rentalHistory)[0]>) => {
      setRentalHistory((prev) =>
      ...
      case 'team':
        ...
        return (
          <View style={styles.section}>
            ...
            {activeProfile?.agencyProfile?.members &&
            activeProfile.agencyProfile.members.length > 0 ? (
          ...
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <View style={[styles.inputGroup, styles.halfWidth]}>
                ...
                <View style={styles.pickerContainer}>
                  {['employed', 'self_employed', 'student', 'retired', 'unemployed', 'other'].map(
                    (status) => (
                      <TouchableOpacity
                        key={status}
                        style={[
          ...
          <View style={styles.section}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.switchGroup}>
                ...
                >
                  <Text
                    style={[styles.switchText, preferences.furnished && styles.switchTextActive]}
                  >
                    Furnished
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    updatePreferences({ parkingRequired: !preferences.parkingRequired })
                  }
                >
                  <Text
                    style={[
                    ...
                    <View style={styles.pickerContainer}>
                      {[
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            updateRentalHistory(index, { reasonForLeaving: reason as any })
                          }
                        >
                          <Text
                            style={[
