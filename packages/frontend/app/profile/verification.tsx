...
export default function VerificationScreen() {
  ...
  const renderVerificationItem = (method: VerificationMethod) => (
    <TouchableOpacity
      key={method.id}
      style={[styles.verificationItem, method.completed ? styles.verificationItemCompleted : {}]}
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
          ...
          <View style={styles.currentVerificationContainer}>
            ...
            <Text style={styles.verificationExplanation}>
              {currentLevel === 'unverified'
                ? t(
                    'You are not verified. Complete the basic verification steps to increase your trust score.',
                  )
                : currentLevel === 'basic'
                  ? t(
                      'You have completed basic verification. Enhance your profile with additional verification.',
                    )
                  : currentLevel === 'enhanced'
                    ? t(
                        'You have enhanced verification. Complete premium verification for maximum trust.',
                      )
        ...
        <View style={styles.benefitsSection}>
          ...
          <View style={styles.benefitItem}>
            ...
            <View style={styles.benefitContent}>
              ...
              <Text style={styles.benefitDescription}>
                {t(
                  'Higher verification levels increase your trust score, making it easier to get rental approvals.',
                )}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.benefitItem}>
            ...
            <View style={styles.benefitContent}>
              ...
              <Text style={styles.benefitDescription}>
                {t(
                  'Premium verified users often experience expedited rental application approvals.',
                )}
              </Text>
            </View>
          </View>
      ...
      <View style={styles.bottomButtonContainer}>
        <TouchableOpacity
          style={[styles.upgradeButton, currentLevel === 'premium' && styles.disabledButton]}
